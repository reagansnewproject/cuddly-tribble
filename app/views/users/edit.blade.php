	...
	<div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-8 col-sm-offset-1 col-xs-8 col-xs-offset-1">
		...
		<form class="form-horizontal" method="POST" action="{{{action('UsersController@doedit', $user->id)}}}">
			...
			<div class="form-group">
				...
				@endif
				<label for="preference">I am looking for someone who is: </label><br>
			...
			<div class="form-group">
				...
				@endif
				<label for="willing">Are you looking to Hookup?</label><br>
			...
			<div class="form-group">
				...
				@endif
					...
					<select name="religion">
						...
						<option value="Rastafarian" <?php if($detail->religion == "Rastafarian") {?> selected <?php } ?>>Rastafarian</option>
						<option value="Pastafarian" <?php if($detail->religion == "Pastafarian") {?> selected <?php } ?>>Pastafarian</option>
						<option value="Hindu" <?php if($detail->religion == "Hindu") {?> selected <?php } ?>>Hindu</option>
						<option value="New Age" <?php if($detail->religion == "New Age") {?> selected <?php } ?>>New Age</option>
				...
				<div class="form-group">
					...
					<select name="politics">
						<option> - Prefer not to Say - </option>
						<option value="Very Liberal" <?php if($detail->politics == "Very Liberal") {?> selected <?php } ?>>Very Liberal</option>
						<option value="Moderately Liberal" <?php if($detail->politics == "Moderately Liberal") {?> selected <?php } ?>>Moderately Liberal</option>
						<option value="Moderate" <?php if($detail->politics == "Moderate") {?> selected <?php } ?>>Moderate</option>
						<option value="Moderately Conservative" <?php if($detail->politics == "Moderately Conservative") {?> selected <?php } ?>>Moderately Conservative</option>
						<option value="Very Conservative" <?php if($detail->politics == "Very Conservative") {?> selected <?php } ?>>Very Conservative</option>
						<option value="Libertarian" <?php if($detail->politics == "Libertarian") {?> selected <?php } ?>>Libertarian</option>
						<option value="Green" <?php if($detail->politics == "Green") {?> selected <?php } ?>>Green</option>
						<option value="Constitutionalist" <?php if($detail->politics == "Constitutionalist") {?> selected <?php } ?>>Constitutionalist</option>
						<option value="Reform" <?php if($detail->politics == "Reform Party") {?> selected <?php } ?>>Reform Party</option>
						<option value="Socialist" <?php if($detail->politics == "Socialist") {?> selected <?php } ?>>Socialist</option>
						<option value="Communist" <?php if($detail->politics == "Communist") {?> selected <?php } ?>>Communist</option>
						<option value="Anarchist" <?php if($detail->politics == "Anarchist") {?> selected <?php } ?>>Anarchist</option>
						<option value="Minarchist" <?php if($detail->politics == "Minarchist") {?> selected <?php } ?>>Minarchist</option>
						<option value="Rent is too damn high" <?php if($detail->politics == "Rent is too damn high") {?> selected <?php } ?>>Rent is too damn high</option>
						<option value="Tea Party" <?php if($detail->politics == "Tea Party") {?> selected <?php } ?>>Tea Party</option>
						<option value="Cyber Party" <?php if($detail->politics == "Cyber Party") {?> selected <?php } ?>>Cyber Party</option>
						<option value="Other" <?php if($detail->politics == "Other") {?> selected <?php } ?>>Other</option>
					</select>
				</div>
				<div class="form-group">
					@if($errors->has('job'))
				...
				@endif
					...
					<select name="body_type">
						<option> - Prefer not to Say - </option>
						<option value="Very Slender" <?php if($detail->body_type == "Very Slender") {?> selected <?php } ?>>Very Slender</option>
						<option value="Slender" <?php if($detail->body_type == "Slender") {?> selected <?php } ?>>Slender</option>
						<option value="Healthy, but not athletic" <?php if($detail->body_type == "Healthy, but not athletic") {?> selected <?php } ?>>Healthy, but not athletic</option>
						<option value="Average" <?php if($detail->body_type == "Average") {?> selected <?php } ?>>Average</option>
						<option value="Slightly above average" <?php if($detail->body_type == "Slightly above average") {?> selected <?php } ?>>Slightly above average</option>
						...
						<option value="Big and Beautiful" <?php if($detail->body_type == "Big and Beautiful") {?> selected <?php } ?>>Big and Beautiful</option>
